...
const Resumen = () => {
    ...
    return(<div className='resumen'><br></br>
        <h1>¡Feliz primer añito, mi amor!</h1>
        <p style={{"textAlign": "center"}}>Aquí están todas tus cartitas para que puedas leerlas cuando quieras.&#128158;</p>
